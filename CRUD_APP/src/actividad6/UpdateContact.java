...
public class UpdateContact {
    ...
    /**
     * Actualiza un contacto en el archivo de la agenda con un nuevo número y correo electrónico.
     * @param name Nombre del contacto a actualizar.
     * @param newNumber Nuevo número de teléfono.
     * @param newEmail Nuevo correo electrónico.
     * @return true si el contacto se actualizó exitosamente, false si el contacto no existe o si ocurrió un error.
     */
